...
export default function ImportPage() {
    ...
    const handleImport = async () => {
        try {
            ...
            if (amountIdx === -1) { setError('Không tìm thấy cột "Số tiền". Vui lòng đặt tên cột rõ ràng.'); setImporting(false); return; }
        ...
        <div className="space-y-6 max-w-[1000px] mx-auto pb-20">
            ...
            {file && rows.length > 0 && !imported && (
                <div className="space-y-4">
                    ...
                    >
                        {importing ? (
                             <><div className="w-5 h-5 border-2 border-white border-t-transparent rounded-full animate-spin" /> Đang import...</>
                        ) : (
