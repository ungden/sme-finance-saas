...
import { ArrowRight, CheckCircle2, Landmark, BarChart3, Users, FileText } from "lucide-react";
    ...
    return (
        <div className="bg-slate-950 min-h-screen text-slate-100 font-sans selection:bg-blue-500/30">
            ...
            <section id="features" className="py-24 border-t border-white/5 bg-slate-900/20">
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="grid md:grid-cols-3 gap-8">
                        <FeatureCard icon={<BarChart3 className="w-6 h-6" />} title="Analytics Đa Năm" desc="Hệ thống tự động dựng 3 Bảng Cân đối kế toán, KQKD và LCTT dựa trên grid nhập liệu thân thiện." />
                        <FeatureCard icon={<Users className="w-6 h-6" />} title="Quản trị ERP & Nhân sự" desc="Module HR & Thiết bị nội bộ. Quỹ lương tự cộng dồn vào OPEX thay vì nhập tay bóc tách thủ công." />
                        <FeatureCard icon={<FileText className="w-6 h-6" />} title="Sẵn sàng Gọi vốn" desc="Khởi chạy báo cáo AI CFO Insights nhận diện rủi ro dòng tiền và xuất File PDF chuẩn Pitch Deck trong 1 click." />
                    </div>
                </div>
            </section>
            ...
            <footer className="border-t border-white/5 py-12 text-center text-slate-500 text-sm">
                ...
                <p>© {new Date().getFullYear()} RealProfit — Mini-ERP Platform for Vietnamese SMEs.</p>
            </footer>
        </div>
    );
}
